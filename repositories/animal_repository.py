...
def save(animal):
    sql = "INSERT INTO animals (name, dob, species, breed, owner_id, vet_id, date_registered) VALUES (%s ,%s, %s, %s, %s, %s, %s) RETURNING id"
    values = [
        animal.name,
        animal.dob,
        animal.species,
...
def update(animal):
    sql = "UPDATE animals SET (name, dob, species, breed, owner_id, vet_id, date_registered) = (%s, %s, %s, %s, %s, %s, %s) WHERE id = %s"
    values = [
        animal.name,
        animal.dob,
        animal.species,
